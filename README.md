...
api gateway in Scala.

## 🚀 Overview
This repository contains a professional implementation of **Scala API Gateway**. It is designed with clean code principles and focuses on functionality and reliability.
